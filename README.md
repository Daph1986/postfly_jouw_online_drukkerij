...
The existing site as it is now no longer meets the needs of customers and employees.
...
- As an employee I want to be able to see a clear overview of the order placed by the customer. (Order)
- As an employee I want to be able to change the status of an order (Admin)
- As an employee I want to be able to updated or delete products of the site. (Admin)
- As an employee I want to be able to download the artwork that was uploaded. (Order details)
...
For customers, the site should be a clear improvement over the existing site. Frequently heard complaints with the existing site include that it is not clear where the artwork should be uploaded and that the payment system is not working.
...
<!-- [Google Fonts](https://fonts.google.com/) was used to embed the XXXXXXX font in the code. XXXXXX was chosen because .
...
- A product page with an overview of the products.
- A product detail page with the price of the chosen product and the delivery time.
- A frequently asked questions page.
- An artwork supply tips and tricks page.
...
- A register page.
- A loging page.
- A order sytem, to order the products and upload the artwork for the products.
- A dashboard, with the users profile and order history.
- An option to choose the language, Dutch or English.
...
- An artwork upload system where you as a customer can check your artwork yourself.
<div align="right"><a href="#top">🔝</a></div>
